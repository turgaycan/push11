...
//		return service.getAllTags(app);
    ...
    public
    @ResponseBody
    List<String> getAllEvents(@RequestBody Application app) {
...
//		return service.getEventValuesForKey(request.getApplication(), request.getName(), request.getEventKey());
    ...
    public
    @ResponseBody
    Map<String, Boolean> getEventValuesForKey(@RequestBody SendPushRequest request) {
//		return service.sendPushToDeviceList(request.getUserIdList(), request.getContent());
    ...
    public
    @ResponseBody
    Map<String, Boolean> newEvent(@RequestBody SendPushRequest sendPushRequest) {
        return null;
    }
